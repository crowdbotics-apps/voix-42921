"""
Django settings for voix_42921 project.
...
WSGI_APPLICATION = 'voix_42921.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "voix_42921 API",
    "DESCRIPTION": "API documentation for voix_42921 App",
    "VERSION": "v1",
}
